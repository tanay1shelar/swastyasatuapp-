...
<head>
    ...
    <title>Camp Admin Dashboard - Swasthya Setu</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <div class="app-wrapper">
        ...
        <aside class="app-sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="#" class="menu-item" onclick="showToast('Navigation', 'Managing camps database')">
                    <i class="fas fa-campground"></i>
                    <span>Medical Camps</span>
                </a>
                <a href="#" class="menu-item" onclick="showToast('Navigation', 'Doctor scheduling')">
                    <i class="fas fa-calendar-alt"></i>
                    <span>Doctor Scheduling</span>
                </a>
                <a href="#" class="menu-item" onclick="showToast('Navigation', 'Health Workers assignments')">
                    <i class="fas fa-users"></i>
                    <span>Health Workers</span>
                </a>
                <a href="#" class="menu-item" onclick="showToast('Navigation', 'Medicine inventory manager')">
        ...
        <main class="main-content">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="dropdown">
                        <div class="profile-dropdown-btn" data-bs-toggle="dropdown">
                            <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150" alt="Profile">
                            <div class="d-none d-lg-block">
                                <h6 class="mb-0" style="font-size: 0.85rem; font-weight: 600;"><?= htmlspecialchars($_SESSION['full_name']); ?></h6>
                                <span class="text-muted small">Camp Admin</span>
                            </div>
                        </div>
            ...
            <div class="content-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h4 class="mb-1 text-dark fw-bold">Camp Operations Dashboard</h4>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="card stat-card blue h-100 p-3">
                            <span class="text-muted small text-uppercase">Organized Camps</span>
                            <h3 class="mb-0 mt-1 fw-bold">24</h3>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="card stat-card green h-100 p-3">
                            <span class="text-muted small text-uppercase">Scheduled Doctors</span>
                            <h3 class="mb-0 mt-1 fw-bold">62 Slots</h3>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="card stat-card teal h-100 p-3">
                            <span class="text-muted small text-uppercase">Medicine Items</span>
                            <h3 class="mb-0 mt-1 fw-bold">8,240</h3>
                        </div>
                    </div>
                </div>
            </div>
