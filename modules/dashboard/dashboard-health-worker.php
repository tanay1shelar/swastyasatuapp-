...
<head>
    ...
    <title>Health Worker Dashboard - Swasthya Setu</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <div class="app-wrapper">
        ...
        <aside class="app-sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="#" class="menu-item" onclick="showToast('Navigation', 'Patient registrations module')">
                    <i class="fas fa-user-plus"></i>
                    <span>Patient Registration</span>
                </a>
                <a href="#" class="menu-item" onclick="showToast('Navigation', 'Appointments queue')">
        ...
        <main class="main-content">
            ...
            <header class="app-header d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="search-box-wrapper d-none d-md-block">
                        ...
                        <input type="text" class="form-control" placeholder="Search registered patients...">
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="dropdown">
                        <div class="profile-dropdown-btn" data-bs-toggle="dropdown">
                            <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150" alt="Profile">
                            <div class="d-none d-lg-block">
                                <h6 class="mb-0" style="font-size: 0.85rem; font-weight: 600;"><?= htmlspecialchars($_SESSION['full_name']); ?></h6>
                                <span class="text-muted small">Health Worker</span>
                            </div>
                        </div>
            ...
            <div class="content-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h4 class="mb-1 text-dark fw-bold">Health Worker Field Desk</h4>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="card stat-card blue h-100 p-3">
                            <span class="text-muted small text-uppercase">Total Registrations</span>
                            <h3 class="mb-0 mt-1 fw-bold">420</h3>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="card stat-card green h-100 p-3">
                            <span class="text-muted small text-uppercase">Today's Appointments</span>
                            <h3 class="mb-0 mt-1 fw-bold">28</h3>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="card stat-card teal h-100 p-3">
                            <span class="text-muted small text-uppercase">Checked-In Patients</span>
                            <h3 class="mb-0 mt-1 fw-bold">22</h3>
                        </div>
                    </div>
                </div>
            </div>
