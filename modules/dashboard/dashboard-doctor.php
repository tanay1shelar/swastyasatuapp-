...
<head>
    ...
    <title>Doctor Dashboard - Swasthya Setu</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <div class="app-wrapper">
        ...
        <aside class="app-sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="#" class="menu-item" onclick="showToast('Navigation', 'Assigned camps list')">
                    <i class="fas fa-clinic-medical"></i>
                    <span>Assigned Camps</span>
                </a>
                <a href="#" class="menu-item" onclick="showToast('Navigation', 'Patients queue')">
        ...
        <main class="main-content">
            ...
            <header class="app-header d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="search-box-wrapper d-none d-md-block">
                        ...
                        <input type="text" class="form-control" placeholder="Search patient queue...">
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="dropdown">
                        <div class="profile-dropdown-btn" data-bs-toggle="dropdown">
                            <img src="https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=150" alt="Profile">
            ...
            <div class="content-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h4 class="mb-1 text-dark fw-bold">Doctor Consultation Desk</h4>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="card stat-card blue h-100 p-3">
                            <span class="text-muted small text-uppercase">Assigned Camps</span>
                            <h3 class="mb-0 mt-1 fw-bold">3</h3>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="card stat-card green h-100 p-3">
                            <span class="text-muted small text-uppercase">Today's Patients</span>
                            <h3 class="mb-0 mt-1 fw-bold">18</h3>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="card stat-card teal h-100 p-3">
                            <span class="text-muted small text-uppercase">Issued Prescriptions</span>
                            <h3 class="mb-0 mt-1 fw-bold">142</h3>
                        </div>
                    </div>
                </div>
            </div>
